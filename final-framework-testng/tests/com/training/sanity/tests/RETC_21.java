...
public class RETC_21 {
	...
	public void validLoginTest() throws InterruptedException {
		...
		//Scenario:To verify whether application allows admin to delete tag from the tag page
		...
		// 3. Click on the checkbox of the tag to be deleted
		...
		Assert.assertEquals(actualMessage, "Tags deleted.");
